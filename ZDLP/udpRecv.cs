...
namespace ZDLP
{
    public class TimeInfo
    {
        ...
        public class BD_GPS
        {
            ...
            public BD_GPS(byte[] t)
            {
                ...
                {
                    DateTime dt_org = new DateTime(year, month, day, hour, minute, second);
    ...
    public class udpRecv
    {
        ...
        public delegate void PassTime(TimeInfo timeInfo);
        ...
        public void udpInit(string LocalIP, string[] GroupIP, int GroupPort)
        {
            ...
            //接收缓存区大小设置
            m_RecvSocket.ReceiveBufferSize = int.MaxValue;
            //绑定本地IP，单网卡可省略此步骤
            ...
            //加入组播组
            foreach(var ip in GroupIP)
                m_RecvSocket.SetSocketOption(SocketOptionLevel.IP, SocketOptionName.AddMembership, new MulticastOption(IPAddress.Parse(ip)));
        }
